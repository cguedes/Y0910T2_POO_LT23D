package person.demo4.otherPackage;
...
public class App {
	...
	public static void main(String[] args) {
		...
		// Reparem que, nesta versão (demo) já não é possível usar os métodos de setXXX
		// porque este código:
		//   a) não está definido em Person
        //   b) não está definido numa classe derivada de Person
		//   c) não está definido no mesmo package que Person
		//pBart.setName("Novo Nome");
